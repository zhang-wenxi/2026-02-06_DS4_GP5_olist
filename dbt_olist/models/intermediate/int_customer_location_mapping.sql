...
-- =====================================================
-- CTE 1b: Normalize city/state (moved from staging)
-- =====================================================
customers_normalized as (
    select
        ...
        -- Accent removal and city correction live here, not in staging
        case
            when customer_city_is_null then 'Unknown'
...
joined as (
    select
        ...
        -- Fallback priority: Official Geo -> Patched Seed -> Customer Normalized
